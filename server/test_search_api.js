...
async function testSearch() {
  ...
  const keyword = "周杰伦";
  const url = `https://music.163.com/api/search/get?s=${encodeURIComponent(keyword)}&type=100&limit=10&offset=0&csrf_token=5926969fd5ec7a23456bb83865e837ff`;
  
  console.log("测试搜索API:", url);
